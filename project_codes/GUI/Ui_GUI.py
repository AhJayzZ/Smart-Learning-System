...
class Ui_SmartLearningSystemGUI(object):
    def setupUi(self, SmartLearningSystemGUI):
        ...
        self.language_label.setGeometry(QtCore.QRect(10, 760, 81, 41))
        font = QtGui.QFont()
        font.setFamily("標楷體")
        font.setPointSize(20)
        ...
        self.language_selector.setGeometry(QtCore.QRect(100, 760, 251, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, SmartLearningSystemGUI):
        ...
        self.language_label.setText(_translate("SmartLearningSystemGUI", "語言:"))
