...
class Ui_SmartLearningSystemGUI(object):
    def setupUi(self, SmartLearningSystemGUI):
        ...
        SmartLearningSystemGUI.resize(1319, 958)
        font = QtGui.QFont()
        ...
        self.confirm_btn.setGeometry(QtCore.QRect(870, 840, 201, 51))
        font = QtGui.QFont()
        ...
        self.clear_btn.setGeometry(QtCore.QRect(1120, 840, 191, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.translated_box.setGeometry(QtCore.QRect(860, 400, 451, 320))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.exit_btn.setGeometry(QtCore.QRect(870, 900, 441, 51))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.contrast_scrollbar.setGeometry(QtCore.QRect(1010, 740, 160, 22))
        ...
        self.brightness_scrollbar.setGeometry(QtCore.QRect(1010, 790, 160, 22))
        ...
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(SmartLearningSystemGUI)
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(1190, 730, 121, 101))
        self.verticalLayoutWidget_3.setObjectName("verticalLayoutWidget_3")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_3)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.translate_mode_label = QtWidgets.QLabel(self.verticalLayoutWidget_3)
        font = QtGui.QFont()
        font.setFamily("標楷體")
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.translate_mode_label.setFont(font)
        self.translate_mode_label.setObjectName("translate_mode_label")
        self.verticalLayout.addWidget(self.translate_mode_label)
        self.sentenceMode_btn = QtWidgets.QRadioButton(self.verticalLayoutWidget_3)
        font = QtGui.QFont()
        font.setFamily("標楷體")
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.sentenceMode_btn.setFont(font)
        self.sentenceMode_btn.setChecked(True)
        self.sentenceMode_btn.setObjectName("sentenceMode_btn")
        self.verticalLayout.addWidget(self.sentenceMode_btn)
        self.vocabularyMode_btn = QtWidgets.QRadioButton(self.verticalLayoutWidget_3)
        font = QtGui.QFont()
        font.setFamily("標楷體")
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.vocabularyMode_btn.setFont(font)
        self.vocabularyMode_btn.setObjectName("vocabularyMode_btn")
        self.verticalLayout.addWidget(self.vocabularyMode_btn)
    ...
    def retranslateUi(self, SmartLearningSystemGUI):
        ...
        self.translate_mode_label.setText(_translate("SmartLearningSystemGUI", "翻譯模式:"))
        self.sentenceMode_btn.setText(_translate("SmartLearningSystemGUI", "句子"))
        self.vocabularyMode_btn.setText(_translate("SmartLearningSystemGUI", "單字"))
