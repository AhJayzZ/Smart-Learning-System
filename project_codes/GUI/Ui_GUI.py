...
class Ui_SmartLearningSystemGUI(object):
    def setupUi(self, SmartLearningSystemGUI):
        ...
        SmartLearningSystemGUI.resize(1319, 1007)
        ...
        self.exit_btn.setGeometry(QtCore.QRect(1090, 900, 200, 50))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.translate_btn.setGeometry(QtCore.QRect(1090, 840, 200, 50))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
