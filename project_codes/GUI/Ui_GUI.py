...
class Ui_SmartLearningSystemGUI(object):
    def setupUi(self, SmartLearningSystemGUI):
        ...
        SmartLearningSystemGUI.resize(1370, 897)
        ...
        self.back_btn.setGeometry(QtCore.QRect(840, 730, 521, 50))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(10, 730, 631, 121))
