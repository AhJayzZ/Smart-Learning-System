...
class Ui_settingPage(object):
    def setupUi(self, settingPage):
        ...
        self.syncDB_btn = QtWidgets.QPushButton(settingPage)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.syncDB_btn.setFont(font)
        self.syncDB_btn.setObjectName("syncDB_btn")
        self.verticalLayout_2.addWidget(self.syncDB_btn)
        self.syncLocal_btn = QtWidgets.QPushButton(settingPage)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.syncLocal_btn.setFont(font)
        self.syncLocal_btn.setObjectName("syncLocal_btn")
        self.verticalLayout_2.addWidget(self.syncLocal_btn)
    ...
    def retranslateUi(self, settingPage):
        ...
        self.syncDB_btn.setText(_translate("settingPage", " 同步資料庫至本地端"))
        self.syncLocal_btn.setText(_translate("settingPage", " 同步本地端至資料庫"))
